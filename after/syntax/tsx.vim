...
syn region tsxChild contained start=+{+ end=++ contains=jsBlock,javascriptBlock
  \ extend
...
syn region tsxRegion
  \ contains=@Spell,@XMLSyntax,tsxRegion,tsxChild,jsBlock,javascriptBlock
...
syn cluster jsExpression add=tsxRegion
